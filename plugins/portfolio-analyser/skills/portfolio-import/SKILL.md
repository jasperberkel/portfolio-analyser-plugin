...
description: Extract, validate, research, analyze, and synchronize one or more attached portfolio documents with the local Portfolio Analyser app. Use for broker exports or manually created holdings documents in structured or unstructured formats, including mixed sources; do not use for general investing questions without portfolio documents.
---

# Portfolio Import

Turn all attached documents that describe the same effective portfolio date into one validated snapshot and one complete German Markdown analysis in the local Portfolio Analyser app.
