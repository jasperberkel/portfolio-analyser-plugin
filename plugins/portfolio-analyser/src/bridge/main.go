...
func (b bridge) status(ctx context.Context, output io.Writer) error {
	...
	request := []byte(`{"jsonrpc":"2.0","id":1,"method":"initialize","params":{"protocolVersion":"2025-06-18","capabilities":{},"clientInfo":{"name":"portfolio-analyser-bridge","version":"0.4.3"}}}`)
